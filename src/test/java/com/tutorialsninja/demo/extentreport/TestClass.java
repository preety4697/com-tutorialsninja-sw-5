...
public class TestClass {
    ...
    public void extentTest() throws IOException {
        ...
        test.pass("TopMenu Test start Successfully");
        test.info("Url is loaded");
        test.info("Values entered");
        test.pass("TopMenu completed successfully");

        //How to highlight the steps
        test.pass(MarkupHelper.createLabel("TopMenu Test completed successfully", ExtentColor.GREEN));
